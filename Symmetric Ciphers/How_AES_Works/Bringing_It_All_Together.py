...
def sub_bytes(s, sbox=s_box):
    """
    Substitutes each byte in the state matrix with the corresponding byte from the S-box.
    """
    result = [[0 for _ in range(4)] for _ in range(4)]
...
def inv_sub_bytes(s):
    """
    Applies inverse SubBytes step on the state matrix.
    """
...
def decrypt(key, ciphertext):
    """
    Decrypts a ciphertext using AES-128.
    """
    # Generate round keys
